...
tags:
  - portable air conditioning Porto
  - AC installation Porto Portugal
  - Porto metro area cooling
  - rented apartment AC Porto
  - Porto summer humidity
  - portable AC price Porto 2026
  - no works AC Porto
...
faq:
  - q: "How much does portable AC cost in Porto in 2026?"
    a: "With Porto Clima curated install, fixed turnkey packages are €899 (up to 20 m²), €1,049 (up to 30 m²) and €1,199 (35–40 m²), VAT included. They cover the Cecotec unit, delivery, survey, window kit, insulation and same-day commissioning. We confirm price on survey before booking."
  - q: "Can I install portable AC in a rented flat in Porto?"
    a: "In most cases yes, as long as you do not drill the facade or permanently alter window frames. We use a removable window seal kit — ideal when landlords will not approve a fixed split. See our rental guide for the landlord email template."
  - q: "Is portable AC enough for Porto summers?"
...
official_sources:
  ...
  - url: https://www.porto.pt/
    label: Porto City Council
  - url: https://www.adene.pt/
    label: ADENE — thermal comfort in buildings
  - url: https://www.cecotec.pt/
    label: Cecotec — manufacturer of units we install
llm_facts:
...
## Why Porto is different from Lisbon for cooling

Porto has many pre-Pombaline and post-war buildings with **thick walls, narrow windows and granite frames**. They store daytime heat and release it slowly at night. In July and August, 32–38 °C with **Atlantic humidity** makes the air feel heavier than the thermometer shows — common in Cedofeita, Bonfim, Campanhã and the Ribeira.

**Officially:** IPMA records several days above 35 °C per season in Greater Porto.

**In practice:** ground floors by the Douro and top floors without shade feel peaks earlier than the city-wide forecast. We measure window, exposure and humidity on survey — not just floor area.

You do not need facade works to stay comfortable. A **portable air conditioner** with a sealed window exhaust solves most 1- and 2-bed flats — provided the kit is well insulated and BTU matches real heat load.
...
| Usable area | Recommended BTU | Porto Clima turnkey |
|-------------|-----------------|---------------------|
| Up to 20 m² (bedroom) | 9,000 | €899 |
| Up to 30 m² (living / 1-bed) | 12,000 | €1,049 |
| 35–40 m² (large living, open plan) | 14,000 | €1,199 |
| Two linked rooms | 2×12,000 | €1,999 (same address) |

**Common mistake:** buying on retail unit price alone. Without thermal and acoustic sealing at the window, you lose 30–40% efficiency and gain street noise — critical on narrow Baixa streets or Boavista.

**In practice:** a poorly sealed 12,000 BTU unit underperforms a well-fitted 9,000 BTU unit on granite windows.
...
6. **Cecotec warranty** + **12 months on our install**.
...
- **Landlord:** most contracts require written consent for permanent changes. Removable window kits are often accepted — always confirm. Details in our [rental guide](/en/guides/portable-ac-rented-apartment-porto/).
- **Condominium:** if the unit does not change the visible facade, many Porto administrators do not require a vote. External units on balconies almost always do.
- **Listed buildings / Ribeira UNESCO zone:** prefer reversible solutions; we do not drill stone or granite frames.

**Common gap:** tenants assume «portable = zero rules». Noise, dripping and visible kits can still trigger complaints without facade works.

## Humidity, drainage and granite windows

In Porto, condensate must go to an **internal tank or fixed drain hose** — not onto the pavement. Basements and ground floors near the Douro have higher ambient humidity; our survey measures **heat load** (afternoon sun, attic, poor airflow).

Sliding or sash granite windows need a **custom adapter plate**. That is where cheap installs fail — hot air leaks in and the unit overworks.

For heatwave context, see our [Porto summer guide](/en/guides/porto-summer-heat-humidity-comfort/).

## Mistakes we see in the AMP (and how we avoid them)

| Mistake | Consequence | Our approach |
|---------|-------------|--------------|
| Tape instead of adapter plate | Efficiency loss, noise | Plate + sealing foam |
| Shared socket with fridge | Tripped breaker | Circuit check on survey |
| Undersized unit in attic | No night cooling | 14k BTU or second unit |
| Duct visible from street | Condo complaint | Discreet interior finish |
| No landlord email | Deposit risk | Template in rental guide |

## Checklist before you request a quote

- [ ] Approximate room size (m²)
- [ ] Window type (sliding, casement, sash)
- [ ] Floor and sun exposure (morning / afternoon)
- [ ] If renting: works clause in contract
...
| Month | What happens | Recommendation |
|-------|--------------|----------------|
...
3. We reply with survey date and stock confirmation — no online payment until booking.
