...
faq:
  ...
  - q: "Posso levar o aparelho quando sair do apartamento?"
    a: "Sim — é uma das vantagens do móvel. Desmontamos o kit, reparamos vedações se necessário e o apartamento fica como estava, salvo furos preexistentes para tomada."
  - q: "E se o condomínio proibir unidades exteriores?"
...
| Passo | Ação |
|-------|------|
| 1 | Ler cláusula de obras / benfeitorias no contrato |
| 2 | Pedir OK ao senhorio (modelo de email abaixo) |
| 3 | Perguntar ao condomínio se há regra sobre AC visível |
...
| Critério | Móvel curado | Split fixo |
|----------|--------------|------------|
| Autorização senhorio | Geralmente mais simples | Quase sempre escrita |
| Condomínio | Raramente assembleia | Frequentemente assembleia |
